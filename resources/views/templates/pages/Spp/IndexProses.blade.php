...
@section('app-title', 'SPP Perlu di Proses')
@section('table-title', 'Spp Perlu di Proses')
@section('table')
@if(session('message'))
            ...
            <tbody>
                ...
                <tr>  
                    ...
                    <td class="uk-text-center">
                       ...
                       <a href="{{ route('Proses.show', ['Prose' => $value->id]) }}" class="uk-button uk-button-secondary uk-button-small" title="preview" uk-tooltip><span uk-icon="icon: file-text"></span></a>
                        </div>
